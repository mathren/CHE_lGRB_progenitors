...
def gitPush(repo, template, description=""):
    ...
    if (push == "Y") or (push == "y"):
        ...
        os.chdir(repo)
        os.system(
            "git add "+template+" && git commit -am 'about to start a run: " + description + " ' && git push"
        )
...
def getTerminationCode(f, terminal_output="output.txt"):
    """
