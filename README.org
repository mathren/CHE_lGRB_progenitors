...
#+author: [[mailto:mrenzo@arizona.edu][Mathieu Renzo]] et al.

#+BEGIN_html
<p align="center">
<a href="https://github.com/mathren/CHE_lGRB_progenitors/raw/main/manuscript/CHE_GRB_progenitors.pdf">
...
Analysis and manuscript for Renzo, Gottlieb et al. 2026, submitted to
AAS Journals.
...
**** ⚠️ Warning ⚠️
GitHub removes the =executable= permissions, so you may need to change
the permission of the scripts in [[./MESA_setup]] with:

#+BEGIN_SRC shell
  chmod +x mk rn re clean
#+END_SRC
...
*** Figure 2 - Herzsprung-Russel diagram
Run [[./scripts/HRD.py]] manually to create

[[./manuscript/figures/HRD.png]]

*** Figure 3 - Multi-panel

Individual panels can be generated from the notebook
[[./scripts/grid_plots.ipynb]] (⚠️ may be out of date). Run
[[./scripts/multi_panel.py]] to generate the multipanel figure.
...
*** Figure 6 - =mesa_128.net= and =approx21_cr60_plus_co56

Run [[./scripts/plot_network_128.py]] to generate

[[./manuscript/figures/network_128.png]]
...
#+END_SRC
** TODO list
- [X] add to zenodo MESA community
- [ ] submit to arxiv
- [ ] archive git repo in zenodo and release new version (at acceptance)
