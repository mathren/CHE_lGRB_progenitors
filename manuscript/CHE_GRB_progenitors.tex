...
however][]{vartanyan:21, gottlieb:24, chan:26}. Even fewer open-source
models of rotating progenitors exist, despite their importance for
jetted explosions, collapsars, MHD-explosions, and/or long
...
ongoing \citep[e.g.,][]{jermyn:23,grichener:25,griffiths:25}. In the meantime, we present here a publicly-available grid of
...
\begin{figure}[tbp]
  ...
  \caption{Compactness as a function initial mass and rotation rate
    for single CHE models. Higher values of compactness tend to, but do not always, favor BH formation.}
  \label{fig:xi_M}
\end{figure}
