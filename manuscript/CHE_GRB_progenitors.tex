...
\begin{abstract}
  %
  The understanding of massive star's collapse and explosion(s) is
...
and, at least in some cases, the collapse successfully reverts into an
...
The core structure of a stellar progenitor at the onset of collapse
...
surface \citep[e.g.,][]{morozova:15} or for the application of
semi-analytic explodability criteria based on existing detailed
simulations \citep[e.g.,][]{mueller:16}. However, it is not sufficient
if one want to investigate the driving of the explosions, the
...
collapsar progenitors, we construct our stellar models at $Z=0.001$
...
in the literature). We note that since the release of \textsc{MESA}
version \texttt{r24.03.1} used here, a small bug in the calculation of
some reverse reaction rates has been fixed. The impact of this may be
significant for detailed nucleosynthesis studies (for which our
network size is anyways sub-optimal) but should not affect
significantly the \emph{structure} of the progenitors at collapse.
