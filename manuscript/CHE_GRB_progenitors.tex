...
radial distribution of mass $r(m)$. The explosion dynamics obtained
with the 22-isotope network model is presumably completely different
than the one obtained with the large network model.
