...
\keywords{
  \uat{High Energy astrophysics}{} ---
  \uat{Massive stars}{} ---
  \uat{Stellar evolution}{} ---
  \uat{Stellar rotation}{} ---
  \uat{Rotationally induced mixing}{} ---
  \uat{Collapsars}{} ---
  \uat{Supernovae}{} ---
  \uat{Long gamma-ray bursts}}
...
$\omega_{\rm ZAMS}/\omega_{\rm crit}$ per each of the 71
$M_{\rm ZAMS}$ values, for a total of 781 stellar models. Of these,
...
has a 14\% success rate, relatively high for models that are
...
ensure the full reproducibility of our results. \todo{finalize figures,
  upload to zenodo, make public}.
