...
collapse dynamics expected may be completely different
based on the weak interactions treatment.
...
\citep[e.g.,][]{kasen:10, gottlieb:24}.
...
We report in \Tabref{tab:explodability} the values of
the mass coordinate where the specific entropy drops below
$s=4\,k_{B}N_{A}$ ($M_{4}$) and the mass gradient at that location
